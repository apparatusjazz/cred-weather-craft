...
function App() {
        ...
        if (!loading && data.days.length > 0) {
            ...
            for (let i = 1; i < 6; i ++) {
               cards.push(<WeatherCard
                   key={`card-${i}`}
                   day={data.days[i]}
                   icon={getWeatherIcon(data.description[i], "dark:text-white text-light-blue text-6xl")}
    ...
    <div className={`${themeLight ? "" : "dark"}`}>
        <div className="App dark:bg-dark-theme bg-light-theme h-screen w-screen">
            <div className="max-w-4xl mx-auto md:px-5 relative pt-10 md:top-1/2 md:-translate-y-96 md:pt-0">
                ...
                <div className="h-0 shadow-md bg-contain bg-no-repeat relative mt-5 pt-[54.92%]"
                    ...
                    <div className="flex place-content-between absolute top-0 ml-3 mt-3 md:mt-5 md:ml-6 text-light-blue dark:text-white"
                        ...
                        <div className="flex text-5xl md:text-6xl items-end">
                            ...
                            <div className="flex-col items-start text-base ml-3 font-medium pb-1 md:pb-3">
                ...
                <img src="/cloud.png" className="absolute dark:opacity-90 hidden lg:block md:top-[260px] md:left-[-150px] md:w-[250px]"/>
                <img src="/cloud.png" className="absolute dark:opacity-50 hidden lg:block h-[150px] md:top-[165px] md:right-[-80px]"/>
